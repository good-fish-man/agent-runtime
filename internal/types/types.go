...
// SubAgentConfig is a minimal local stand-in for the reference runner's
// subagent.SubAgentConfig. It is intentionally trimmed: only the fields needed
// so that RunRequest remains self-contained without importing the heavy
// subagent package. Extend as needed when the subagent package is migrated.
