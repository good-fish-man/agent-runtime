...
CACHE_ROOT="${ATHENA_GATE_CACHE_ROOT:-${TMPDIR:-/tmp}/athena-v0.4-gates}"
...
printf '\n[v0.4] ENGINEERING_VERIFIED\n'
printf '[v0.4] This result does not close the external v0.3 release-evidence gates.\n'
